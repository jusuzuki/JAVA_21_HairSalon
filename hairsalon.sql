...
CREATE TABLE stylists (
    id integer NOT NULL,
    name_stylist character varying
);
...
COPY clients (id, name_client, stylist_id) FROM stdin;
\.
...
COPY stylists (id, name_stylist) FROM stdin;
\.
...
SELECT pg_catalog.setval('stylists_id_seq', 43, true);
